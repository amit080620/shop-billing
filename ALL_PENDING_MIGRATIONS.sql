-- ============================================================
-- The Ray — Shop Billing SaaS  |  Migrations 0001 through 0027
-- Run ONCE on a database that already has the baseline (0000).
-- For a brand-new database, use supabase/schema.sql instead.
-- ============================================================
...
-- ==== 0038_fix_inclusive_line_subtotals.sql ====
...
-- ==== 0039_money_balance_functions.sql ====
