/** The plans migration (supabase/migrations/0040_subscription_plans.sql), kept as a
 * string so the admin panel can offer it as one click to copy while the
 * database is still waiting for it. A test keeps the two identical. */
export const PLANS_MIGRATION_SQL = `-- Subscription plans: Free / Basic / Pro / Pro+ / Custom.
--
