...
export interface Database {
  public: {
    Tables: {
      ...
      shelf_watches: {
        Row: { id: string; shop_id: string; name: string; photo_url: string | null; last_checked_at: string; created_at: string };
        Insert: { id?: string; shop_id: string; name: string; photo_url?: string | null; last_checked_at?: string; created_at?: string };
        Update: { id?: string; shop_id?: string; name?: string; photo_url?: string | null; last_checked_at?: string; created_at?: string };
        Relationships: [];
      };
      customer_network_profiles: {
        Row: { phone: string; shops_visited_count: number; reliability_tier: "new" | "building" | "trusted"; last_computed_at: string };
        Insert: { phone: string; shops_visited_count?: number; reliability_tier?: "new" | "building" | "trusted"; last_computed_at?: string };
        Update: { phone?: string; shops_visited_count?: number; reliability_tier?: "new" | "building" | "trusted"; last_computed_at?: string };
        Relationships: [];
      };
      daily_briefings: {
      ...
      shop_medicine_library: {
        Row: { id: string; shop_id: string; medicine_name: string; usage_count: number; last_used_at: string; created_at: string; price: number | null; manufacturer_name: string | null; medicine_type: string | null; pack_size_label: string | null; composition: string | null; description: string | null; side_effects: string | null; short_composition1: string | null; short_composition2: string | null; drug_interactions: unknown; is_discontinued: boolean };
