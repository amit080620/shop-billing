...
const STATIC_PAGES: { title: string; subtitle: string; href: string; keywords: string[] }[] = [
  ...
  { title: "Parties", subtitle: "Customers & suppliers, one place", href: "/parties", keywords: ["customer", "vendor", "supplier", "udhaar", "credit", "payable", "parties"] },
  { title: "Customers", subtitle: "Ledger and credit", href: "/parties?context=customers", keywords: ["customer", "udhaar", "credit"] },
  { title: "Vendors", subtitle: "Suppliers and payables", href: "/parties?context=suppliers", keywords: ["vendor", "supplier", "payable"] },
  { title: "Staff", subtitle: "Manage staff & permissions", href: "/staff", keywords: ["staff", "employee", "permission"] },
  { title: "Clinic settings", subtitle: "Prescription pad, letterhead", href: "/clinic/settings", keywords: ["clinic settings", "prescription pad"] },
  { title: "Calendar management", subtitle: "Working hours & slot gap", href: "/clinic/settings/booking", keywords: ["booking settings", "working hours", "slot"] },
  { title: "Classes", subtitle: "Gym class schedule & instructors", href: "/gym/classes", keywords: ["classes", "gym schedule"] },
  { title: "Check-in kiosk", subtitle: "Self check-in screen setup", href: "/gym/kiosk-settings", keywords: ["kiosk", "check-in"] },
  { title: "Sell a membership", subtitle: "Enroll a new gym member", href: "/gym/members/new", keywords: ["new member", "membership"] },
  { title: "New lab order", subtitle: "Book a test for a patient", href: "/lab/orders/new", keywords: ["lab order", "test booking"] },
  { title: "Kitchen display settings", subtitle: "KDS station setup", href: "/restaurant/kds-settings", keywords: ["kds", "kitchen display"] },
  ...
  { title: "Thermal print settings", subtitle: "Bold & size for 58mm / 80mm receipts", href: "/thermal-print-settings", keywords: ["thermal print", "bluetooth printer", "58mm", "80mm", "receipt font"] },
