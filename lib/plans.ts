...
export const PLANS: Record<Exclude<PlanKey, "custom">, Plan> & { custom: Plan } = {
  free: {
    ...
    highlights: [
      ...
      "Udhaar khata and customer list",
      "Day summary and basic sales reports",
  ...
  pro: {
    key: "pro",
    name: "Pro",
    tagline: "The full shop: GST filing, online orders, staff accountability",
    priceYearly: 3999,
    priceMonthly: 449,
    ...
    highlights: [
      "GSTR-1, GSTR-3B and the CA export",
      "Insights, profit, staff-wise day summary",
