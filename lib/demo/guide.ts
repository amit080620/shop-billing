...
export function guideBlocks(base: string, extraLinks: { label: string; url: string }[] = []): GuideBlock[] {
  ...
  blocks.push({
    ul: [
      ...
      "Light and dark mode: the theme switch is in the menu (More) under settings. Dark mode looks good on video.",
      "Language: English, Hindi and Marathi. Switch in the menu. It changes the whole app.",
