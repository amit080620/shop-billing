 ...
 * strips a leading +91 (or bare 91) if present, so re-editing an
 * existing customer's number doesn't show "+91+919876543210". */
function digitsOnly(value: string): string {
  const cleaned = value.replace(/\D/g, "");
  if (cleaned.startsWith("91") && cleaned.length > 10) return cleaned.slice(2, 12);
